...
```powershell
$PageBeanJqlFunctionPrecomputationBean = Initialize-PSJiraPageBeanJqlFunctionPrecomputationBean  -IsLast null `
 -MaxResults null `
 -NextPage null `
 -Self null `
 -StartAt null `
...
```powershell
$PageBeanJqlFunctionPrecomputationBean | ConvertTo-JSON
```
