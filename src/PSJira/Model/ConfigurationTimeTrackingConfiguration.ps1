...
ConfigurationTimeTrackingConfiguration<PSCustomObject>
#>

function Initialize-ConfigurationTimeTrackingConfiguration {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ConfigurationTimeTrackingConfiguration' | Write-Debug
...
Convert from JSON to ConfigurationTimeTrackingConfiguration<PSCustomObject>
...
ConfigurationTimeTrackingConfiguration<PSCustomObject>
#>
function ConvertFrom-JsonToConfigurationTimeTrackingConfiguration {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ConfigurationTimeTrackingConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ConfigurationTimeTrackingConfiguration
