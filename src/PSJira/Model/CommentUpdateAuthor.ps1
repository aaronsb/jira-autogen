...
CommentUpdateAuthor<PSCustomObject>
#>

function Initialize-CommentUpdateAuthor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => CommentUpdateAuthor' | Write-Debug
...
Convert from JSON to CommentUpdateAuthor<PSCustomObject>
...
CommentUpdateAuthor<PSCustomObject>
#>
function ConvertFrom-JsonToCommentUpdateAuthor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => CommentUpdateAuthor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CommentUpdateAuthor
