...
function Initialize-PageBeanFieldConfigurationDetails {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanFieldConfigurationDetails' | Write-Debug
...
function ConvertFrom-JsonToPageBeanFieldConfigurationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanFieldConfigurationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
