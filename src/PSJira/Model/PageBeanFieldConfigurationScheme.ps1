...
function Initialize-PageBeanFieldConfigurationScheme {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanFieldConfigurationScheme' | Write-Debug
...
function ConvertFrom-JsonToPageBeanFieldConfigurationScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanFieldConfigurationScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
