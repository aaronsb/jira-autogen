...
AttachmentMetadataAuthor<PSCustomObject>
#>

function Initialize-AttachmentMetadataAuthor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => AttachmentMetadataAuthor' | Write-Debug
...
Convert from JSON to AttachmentMetadataAuthor<PSCustomObject>
...
AttachmentMetadataAuthor<PSCustomObject>
#>
function ConvertFrom-JsonToAttachmentMetadataAuthor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => AttachmentMetadataAuthor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AttachmentMetadataAuthor
