...
ProjectComponentAssignee<PSCustomObject>
#>

function Initialize-ProjectComponentAssignee {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ProjectComponentAssignee' | Write-Debug
...
Convert from JSON to ProjectComponentAssignee<PSCustomObject>
...
ProjectComponentAssignee<PSCustomObject>
#>
function ConvertFrom-JsonToProjectComponentAssignee {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ProjectComponentAssignee' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectComponentAssignee
