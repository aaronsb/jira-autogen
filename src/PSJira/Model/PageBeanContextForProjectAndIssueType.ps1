...
function Initialize-PageBeanContextForProjectAndIssueType {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanContextForProjectAndIssueType' | Write-Debug
...
function ConvertFrom-JsonToPageBeanContextForProjectAndIssueType {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanContextForProjectAndIssueType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
