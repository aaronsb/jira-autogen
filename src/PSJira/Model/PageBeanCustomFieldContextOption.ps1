...
function Initialize-PageBeanCustomFieldContextOption {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanCustomFieldContextOption' | Write-Debug
...
function ConvertFrom-JsonToPageBeanCustomFieldContextOption {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanCustomFieldContextOption' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
