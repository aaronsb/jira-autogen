...
FilterSharedUsers<PSCustomObject>
#>

function Initialize-FilterSharedUsers {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => FilterSharedUsers' | Write-Debug
...
Convert from JSON to FilterSharedUsers<PSCustomObject>
...
FilterSharedUsers<PSCustomObject>
#>
function ConvertFrom-JsonToFilterSharedUsers {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => FilterSharedUsers' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FilterSharedUsers
