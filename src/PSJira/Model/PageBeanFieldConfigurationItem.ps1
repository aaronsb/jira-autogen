...
function Initialize-PageBeanFieldConfigurationItem {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanFieldConfigurationItem' | Write-Debug
...
function ConvertFrom-JsonToPageBeanFieldConfigurationItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanFieldConfigurationItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
