...
FilterSubscriptionUser<PSCustomObject>
#>

function Initialize-FilterSubscriptionUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => FilterSubscriptionUser' | Write-Debug
...
Convert from JSON to FilterSubscriptionUser<PSCustomObject>
...
FilterSubscriptionUser<PSCustomObject>
#>
function ConvertFrom-JsonToFilterSubscriptionUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => FilterSubscriptionUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FilterSubscriptionUser
