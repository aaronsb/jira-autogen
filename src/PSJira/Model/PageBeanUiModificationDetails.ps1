...
function Initialize-PageBeanUiModificationDetails {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanUiModificationDetails' | Write-Debug
...
function ConvertFrom-JsonToPageBeanUiModificationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanUiModificationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
