...
WorklogUpdateAuthor<PSCustomObject>
#>

function Initialize-WorklogUpdateAuthor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => WorklogUpdateAuthor' | Write-Debug
...
Convert from JSON to WorklogUpdateAuthor<PSCustomObject>
...
WorklogUpdateAuthor<PSCustomObject>
#>
function ConvertFrom-JsonToWorklogUpdateAuthor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => WorklogUpdateAuthor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorklogUpdateAuthor
