...
function Initialize-PageBeanIssueTypeScreenScheme {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueTypeScreenScheme' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueTypeScreenScheme {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueTypeScreenScheme' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
