...
ChangelogAuthor<PSCustomObject>
#>

function Initialize-ChangelogAuthor {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ChangelogAuthor' | Write-Debug
...
Convert from JSON to ChangelogAuthor<PSCustomObject>
...
ChangelogAuthor<PSCustomObject>
#>
function ConvertFrom-JsonToChangelogAuthor {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ChangelogAuthor' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ChangelogAuthor
