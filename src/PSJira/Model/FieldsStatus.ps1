...
FieldsStatus<PSCustomObject>
#>

function Initialize-FieldsStatus {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => FieldsStatus' | Write-Debug
...
Convert from JSON to FieldsStatus<PSCustomObject>
...
FieldsStatus<PSCustomObject>
#>
function ConvertFrom-JsonToFieldsStatus {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => FieldsStatus' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FieldsStatus
