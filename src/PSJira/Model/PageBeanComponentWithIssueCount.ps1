...
function Initialize-PageBeanComponentWithIssueCount {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanComponentWithIssueCount' | Write-Debug
...
function ConvertFrom-JsonToPageBeanComponentWithIssueCount {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanComponentWithIssueCount' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
