...
function Initialize-CustomFieldContextDefaultValueForgeMultiGroupField {
    ...
    Process {
        'Creating PSCustomObject: PSJira => CustomFieldContextDefaultValueForgeMultiGroupField' | Write-Debug
...
function ConvertFrom-JsonToCustomFieldContextDefaultValueForgeMultiGroupField {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => CustomFieldContextDefaultValueForgeMultiGroupField' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
