...
FieldsAssignee<PSCustomObject>
#>

function Initialize-FieldsAssignee {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => FieldsAssignee' | Write-Debug
...
Convert from JSON to FieldsAssignee<PSCustomObject>
...
FieldsAssignee<PSCustomObject>
#>
function ConvertFrom-JsonToFieldsAssignee {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => FieldsAssignee' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FieldsAssignee
