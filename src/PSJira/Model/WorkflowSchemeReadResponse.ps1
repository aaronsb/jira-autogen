...
.PARAMETER ProjectIdsUsingScheme
...
function Initialize-WorkflowSchemeReadResponse {
    ...
    Process {
        'Creating PSCustomObject: PSJira => WorkflowSchemeReadResponse' | Write-Debug
        ...
        if ($null -eq $ProjectIdsUsingScheme) {
            throw "invalid value for 'ProjectIdsUsingScheme', 'ProjectIdsUsingScheme' cannot be null."
        }
...
function ConvertFrom-JsonToWorkflowSchemeReadResponse {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => WorkflowSchemeReadResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkflowSchemeReadResponse
        $AllProperties = ("defaultWorkflow", "description", "id", "name", "projectIdsUsingScheme", "scope", "taskId", "version", "workflowsForIssueTypes")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "projectIdsUsingScheme"))) {
            throw "Error! JSON cannot be serialized due to the required property 'projectIdsUsingScheme' missing."
        } else {
            $ProjectIdsUsingScheme = $JsonParameters.PSobject.Properties["projectIdsUsingScheme"].value
        }
