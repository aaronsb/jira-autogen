...
function Initialize-PageBeanIssueTypeScreenSchemesProjects {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueTypeScreenSchemesProjects' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueTypeScreenSchemesProjects {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueTypeScreenSchemesProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
