...
function Initialize-PageBeanContextualConfiguration {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanContextualConfiguration' | Write-Debug
...
function ConvertFrom-JsonToPageBeanContextualConfiguration {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanContextualConfiguration' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
