...
function Initialize-PageBeanIssueTypeSchemeProjects {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueTypeSchemeProjects' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueTypeSchemeProjects {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueTypeSchemeProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
