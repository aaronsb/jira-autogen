...
ProjectAvatarUrls<PSCustomObject>
#>

function Initialize-ProjectAvatarUrls {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ProjectAvatarUrls' | Write-Debug
...
Convert from JSON to ProjectAvatarUrls<PSCustomObject>
...
ProjectAvatarUrls<PSCustomObject>
#>
function ConvertFrom-JsonToProjectAvatarUrls {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ProjectAvatarUrls' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectAvatarUrls
