...
function Initialize-PageBeanIssueSecuritySchemeToProjectMapping {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueSecuritySchemeToProjectMapping' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueSecuritySchemeToProjectMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueSecuritySchemeToProjectMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
