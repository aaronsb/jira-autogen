...
FilterOwner<PSCustomObject>
#>

function Initialize-FilterOwner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => FilterOwner' | Write-Debug
...
Convert from JSON to FilterOwner<PSCustomObject>
...
FilterOwner<PSCustomObject>
#>
function ConvertFrom-JsonToFilterOwner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => FilterOwner' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FilterOwner
