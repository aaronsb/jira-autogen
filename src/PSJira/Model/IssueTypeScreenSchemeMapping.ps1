...
function Initialize-IssueTypeScreenSchemeMapping {
    ...
    Process {
        'Creating PSCustomObject: PSJira => IssueTypeScreenSchemeMapping' | Write-Debug
...
function ConvertFrom-JsonToIssueTypeScreenSchemeMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => IssueTypeScreenSchemeMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
