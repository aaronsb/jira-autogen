...
function Initialize-WorkflowMetadataRestModel {
    ...
    Process {
        'Creating PSCustomObject: PSJira => WorkflowMetadataRestModel' | Write-Debug
...
function ConvertFrom-JsonToWorkflowMetadataRestModel {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => WorkflowMetadataRestModel' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkflowMetadataRestModel
        $AllProperties = ("description", "id", "name", "usage", "version")
