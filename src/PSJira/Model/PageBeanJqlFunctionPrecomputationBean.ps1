...
PageBeanJqlFunctionPrecomputationBean<PSCustomObject>
#>

function Initialize-PageBeanJqlFunctionPrecomputationBean {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanJqlFunctionPrecomputationBean' | Write-Debug
...
Convert from JSON to PageBeanJqlFunctionPrecomputationBean<PSCustomObject>
...
PageBeanJqlFunctionPrecomputationBean<PSCustomObject>
#>
function ConvertFrom-JsonToPageBeanJqlFunctionPrecomputationBean {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanJqlFunctionPrecomputationBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PageBeanJqlFunctionPrecomputationBean
