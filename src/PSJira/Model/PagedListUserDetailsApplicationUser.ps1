...
function Initialize-PagedListUserDetailsApplicationUser {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PagedListUserDetailsApplicationUser' | Write-Debug
...
function ConvertFrom-JsonToPagedListUserDetailsApplicationUser {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PagedListUserDetailsApplicationUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
