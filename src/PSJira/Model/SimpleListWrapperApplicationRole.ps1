...
function Initialize-SimpleListWrapperApplicationRole {
    ...
    Process {
        'Creating PSCustomObject: PSJira => SimpleListWrapperApplicationRole' | Write-Debug
...
function ConvertFrom-JsonToSimpleListWrapperApplicationRole {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => SimpleListWrapperApplicationRole' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
