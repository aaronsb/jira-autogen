...
function Initialize-PageBeanSecuritySchemeWithProjects {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanSecuritySchemeWithProjects' | Write-Debug
...
function ConvertFrom-JsonToPageBeanSecuritySchemeWithProjects {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanSecuritySchemeWithProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
