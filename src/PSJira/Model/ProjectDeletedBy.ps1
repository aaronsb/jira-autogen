...
ProjectDeletedBy<PSCustomObject>
#>

function Initialize-ProjectDeletedBy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ProjectDeletedBy' | Write-Debug
...
Convert from JSON to ProjectDeletedBy<PSCustomObject>
...
ProjectDeletedBy<PSCustomObject>
#>
function ConvertFrom-JsonToProjectDeletedBy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ProjectDeletedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectDeletedBy
