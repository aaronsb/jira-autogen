...
FieldsTimetracking<PSCustomObject>
#>

function Initialize-FieldsTimetracking {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => FieldsTimetracking' | Write-Debug
...
Convert from JSON to FieldsTimetracking<PSCustomObject>
...
FieldsTimetracking<PSCustomObject>
#>
function ConvertFrom-JsonToFieldsTimetracking {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => FieldsTimetracking' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FieldsTimetracking
