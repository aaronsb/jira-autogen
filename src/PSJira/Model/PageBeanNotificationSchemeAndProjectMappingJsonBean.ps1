...
function Initialize-PageBeanNotificationSchemeAndProjectMappingJsonBean {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanNotificationSchemeAndProjectMappingJsonBean' | Write-Debug
...
function ConvertFrom-JsonToPageBeanNotificationSchemeAndProjectMappingJsonBean {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanNotificationSchemeAndProjectMappingJsonBean' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
