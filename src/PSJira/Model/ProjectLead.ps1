...
ProjectLead<PSCustomObject>
#>

function Initialize-ProjectLead {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ProjectLead' | Write-Debug
...
Convert from JSON to ProjectLead<PSCustomObject>
...
ProjectLead<PSCustomObject>
#>
function ConvertFrom-JsonToProjectLead {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ProjectLead' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectLead
