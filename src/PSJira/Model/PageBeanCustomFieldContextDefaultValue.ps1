...
function Initialize-PageBeanCustomFieldContextDefaultValue {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanCustomFieldContextDefaultValue' | Write-Debug
...
function ConvertFrom-JsonToPageBeanCustomFieldContextDefaultValue {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanCustomFieldContextDefaultValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
