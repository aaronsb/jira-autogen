...
ProjectArchivedBy<PSCustomObject>
#>

function Initialize-ProjectArchivedBy {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ProjectArchivedBy' | Write-Debug
...
Convert from JSON to ProjectArchivedBy<PSCustomObject>
...
ProjectArchivedBy<PSCustomObject>
#>
function ConvertFrom-JsonToProjectArchivedBy {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ProjectArchivedBy' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectArchivedBy
