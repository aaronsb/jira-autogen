...
ProjectIssueCreateMetadataAvatarUrls<PSCustomObject>
#>

function Initialize-ProjectIssueCreateMetadataAvatarUrls {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => ProjectIssueCreateMetadataAvatarUrls' | Write-Debug
...
Convert from JSON to ProjectIssueCreateMetadataAvatarUrls<PSCustomObject>
...
ProjectIssueCreateMetadataAvatarUrls<PSCustomObject>
#>
function ConvertFrom-JsonToProjectIssueCreateMetadataAvatarUrls {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => ProjectIssueCreateMetadataAvatarUrls' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectIssueCreateMetadataAvatarUrls
