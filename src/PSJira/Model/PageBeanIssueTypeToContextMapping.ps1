...
function Initialize-PageBeanIssueTypeToContextMapping {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueTypeToContextMapping' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueTypeToContextMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueTypeToContextMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
