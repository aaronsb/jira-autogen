...
function Initialize-PageBeanIssueSecurityLevelMember {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueSecurityLevelMember' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueSecurityLevelMember {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueSecurityLevelMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
