...
function Initialize-PageBeanCustomFieldContextProjectMapping {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanCustomFieldContextProjectMapping' | Write-Debug
...
function ConvertFrom-JsonToPageBeanCustomFieldContextProjectMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanCustomFieldContextProjectMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
