...
function Initialize-PageBeanSecurityLevelMember {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanSecurityLevelMember' | Write-Debug
...
function ConvertFrom-JsonToPageBeanSecurityLevelMember {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanSecurityLevelMember' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
