...
function Initialize-PageBeanWorkflowTransitionRules {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanWorkflowTransitionRules' | Write-Debug
...
function ConvertFrom-JsonToPageBeanWorkflowTransitionRules {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanWorkflowTransitionRules' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
