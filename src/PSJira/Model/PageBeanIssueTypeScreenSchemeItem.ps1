...
function Initialize-PageBeanIssueTypeScreenSchemeItem {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueTypeScreenSchemeItem' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueTypeScreenSchemeItem {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueTypeScreenSchemeItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
