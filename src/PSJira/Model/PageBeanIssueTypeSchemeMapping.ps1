...
function Initialize-PageBeanIssueTypeSchemeMapping {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanIssueTypeSchemeMapping' | Write-Debug
...
function ConvertFrom-JsonToPageBeanIssueTypeSchemeMapping {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanIssueTypeSchemeMapping' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
