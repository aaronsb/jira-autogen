...
WorkflowSchemeLastModifiedUser<PSCustomObject>
#>

function Initialize-WorkflowSchemeLastModifiedUser {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSJira => WorkflowSchemeLastModifiedUser' | Write-Debug
...
Convert from JSON to WorkflowSchemeLastModifiedUser<PSCustomObject>
...
WorkflowSchemeLastModifiedUser<PSCustomObject>
#>
function ConvertFrom-JsonToWorkflowSchemeLastModifiedUser {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => WorkflowSchemeLastModifiedUser' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WorkflowSchemeLastModifiedUser
