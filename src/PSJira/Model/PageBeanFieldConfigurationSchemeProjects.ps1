...
function Initialize-PageBeanFieldConfigurationSchemeProjects {
    ...
    Process {
        'Creating PSCustomObject: PSJira => PageBeanFieldConfigurationSchemeProjects' | Write-Debug
...
function ConvertFrom-JsonToPageBeanFieldConfigurationSchemeProjects {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => PageBeanFieldConfigurationSchemeProjects' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
