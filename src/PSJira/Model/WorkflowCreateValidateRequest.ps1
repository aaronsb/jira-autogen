...
function Initialize-WorkflowCreateValidateRequest {
    ...
    Process {
        'Creating PSCustomObject: PSJira => WorkflowCreateValidateRequest' | Write-Debug
...
function ConvertFrom-JsonToWorkflowCreateValidateRequest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSJira => WorkflowCreateValidateRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
